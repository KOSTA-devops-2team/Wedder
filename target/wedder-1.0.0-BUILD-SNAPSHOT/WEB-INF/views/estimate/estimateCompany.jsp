...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='resources/css/estimate/estimateCompany.css'/>"/>
    <!-- 스크립트 -->
    ...
    <div class="hd__inner1100">
                ...
                <section class="body">
                    <div class="body-studio">
                        <div class="body-grid">
                            <div class="item">
                                <div class="image">
                                    <img src="https://wdrtest1.s3.ap-northeast-2.amazonaws.com/reservation/studio-2.png" alt="Wedding Photo" width="100">
                                </div>
                                <div class="detail">
                ...
                <section class="body">
                    <div class="body-dress">
                        <div class="body-grid">
                            <div class="item">
                                <div class="image">
                                    <img src="https://wdrtest1.s3.ap-northeast-2.amazonaws.com/reservation/studio-1.png" alt="Wedding Photo" width="100">
                                </div>
                                <div class="detail">
                                    <div class="title">S 스튜디오</div>
                                    <div class="address">서울특별시 서초구 신반포로 41길 7</div>
        ...
        <section id="modal" class="modal-region">
            <div class="modal-content">
                ...
                <div class="modal-btn">
                    <a href="#"><button class="apply-btn">Apply</button></a>
