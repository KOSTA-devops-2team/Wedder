$(document).ready(function () {
    ...
    function goToPage(page) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                searchCompanyList(response.studioList);
    ...
    // 검색 결과를 처리하는 함수
    function searchCompanyList(studioList) {
        // studioList가 null이나 undefined일 경우 빈 배열로 설정
        ...
        studioList.forEach(function (studio) {
            studioListHtml += `
                        ...
                        <img class="card-img" src ="${studio.imgUrl}"/></a>
                        <div class="card-info">
